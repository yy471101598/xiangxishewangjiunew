...
public class ESCUtil
{
    ...
    public static byte[] generateMockData()
    {
        try
        {
            byte[] tickname = "快速换购小票".getBytes("gb2312");
            byte[] ordernum = "换购单号:".getBytes("gb2312");
            byte[] vipcardnum = "会员卡号:".getBytes("gb2312");
            byte[] vipname = "会员名称:".getBytes("gb2312");
            byte[] xiahuaxian = "----------------------:".getBytes("gb2312");
            byte[] xiaofeinum = "换购积分:".getBytes("gb2312");
            byte[] youhuinum = "优惠积分:".getBytes("gb2312");
            byte[] getjifen = "获得酒瓶:".getBytes("gb2312");
            byte[] shoulepay = "应付积分:".getBytes("gb2312");
            byte[] factpay = "实付积分:".getBytes("gb2312");
            byte[] zhaoqian = "找零积分:".getBytes("gb2312");
            byte[] user = "操作人员:".getBytes("gb2312");
            byte[] ordertime = "换购时间:".getBytes("gb2312");
