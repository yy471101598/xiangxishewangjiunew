...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String shop_pointPercent = "pointPercent"; //获得酒瓶比例
    public static final String shop_discount = "discount";//折扣比例
    public static final String shop_shopname = "shopname";//折扣比例
    public static final String shop_discountmoney= "discountmoney";//换购折后积分  数量*单价的折后
    public static final String shop_goodspoint= "goodspoint";
    public static final String shop_point = "point";//换购获得的酒瓶  根据折后积分
